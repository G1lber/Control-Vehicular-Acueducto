  ...
  getAvailableFields(reportType) {
    const fieldsConfig = {
      ...
      users: [
        ...
        { key: 'grupo', label: 'Grupo (con Otro)', type: 'string' },
        { key: 'tipoContratacion', label: 'Tipo Contratación', type: 'string' },
        { key: 'medioTransporteDesplazamiento', label: 'Medio Transporte Desplazamiento', type: 'string' },
        { key: 'claseVehiculo', label: 'Clase Vehículo (con Otro)', type: 'string' },
        ...
        { key: 'experiencia', label: 'Experiencia', type: 'string' },
        { key: 'accidente5Anios', label: 'Accidentes 5 Años', type: 'string' },
        { key: 'accidenteLaboral', label: 'Accidente Laboral', type: 'string' },
        { key: 'cantidadAccidentes', label: 'Cantidad Accidentes', type: 'string' },
        { key: 'cantidadAccidentesLaborales', label: 'Cantidad Accidentes Laborales', type: 'string' },
        { key: 'rolAccidente', label: 'Rol en Accidente', type: 'string' },
        { key: 'incidente', label: 'Incidente', type: 'string' },
        { key: 'viasPublicas', label: 'Usa Vías Públicas', type: 'string' },
        { key: 'medioDesplazamiento', label: 'Medio Desplazamiento', type: 'string' },
        { key: 'frecuenciaVehiculoPropio', label: 'Frecuencia Vehículo Propio', type: 'string' },
        { key: 'tipoVehiculoPropio', label: 'Tipo Vehículo Propio (con Otro)', type: 'string' },
        { key: 'empresaPagaRodamiento', label: 'Empresa Paga Rodamiento', type: 'string' },
        { key: 'realizaInspeccionPropio', label: 'Realiza Inspección Propio', type: 'string' },
        { key: 'frecuenciaChequeoPropio', label: 'Frecuencia Chequeo Propio', type: 'string' },
        { key: 'usaVehiculoEmpresa', label: 'Usa Vehículo Empresa', type: 'string' },
        { key: 'tipoVehiculoEmpresa', label: 'Tipo Vehículo Empresa (con Otro)', type: 'string' },
        { key: 'realizaInspeccionEmpresa', label: 'Realiza Inspección Empresa', type: 'string' },
        { key: 'frecuenciaChequeoEmpresa', label: 'Frecuencia Chequeo Empresa', type: 'string' },
        { key: 'planificacion', label: 'Planificación', type: 'string' },
        { key: 'antelacion', label: 'Antelación', type: 'string' },
        { key: 'kmMensuales', label: 'KM Mensuales', type: 'number' },
        { key: 'tieneComparendos', label: 'Comparendos', type: 'string' },
        { key: 'riesgos', label: 'Riesgos (con Otro)', type: 'string' },
        { key: 'causas', label: 'Causas (con Otra)', type: 'string' },
        { key: 'causasComparendo', label: 'Causas Comparendo (con Otra)', type: 'string' },
        { key: 'informacionAdicional', label: 'Información Adicional', type: 'string' },
