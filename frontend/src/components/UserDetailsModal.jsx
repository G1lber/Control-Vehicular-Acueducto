  ...
  const handleSaveSurvey = async () => {
    try {
      ...
      const surveyData = {
        ...
        tipoVehiculoPropio: formData.tipo_vehiculo_propio,
        tipoVehiculoPropioOtro: formData.tipo_vehiculo_propio_otro,
        empresaPagaRodamiento: formData.empresa_paga_rodamiento,
        realizaInspeccionPropio: formData.realiza_inspeccion_propio,
        frecuenciaChequeoPropio: formData.frecuencia_chequeo_propio,
        usaVehiculoEmpresa: formData.usa_vehiculo_empresa,
        tipoVehiculoEmpresa: formData.tipo_vehiculo_empresa,
        tipoVehiculoEmpresaOtro: formData.tipo_vehiculo_empresa_otro,
        realizaInspeccionEmpresa: formData.realiza_inspeccion_empresa,
        frecuenciaChequeoEmpresa: formData.frecuencia_chequeo_empresa,
      ...
      try {
        ...
        if (surveyResponse.ok) {
          ...
          const mappedSurveyData = {
            ...
            tipo_vehiculo_propio: updatedSurveyData.tipoVehiculoPropio || '',
            tipo_vehiculo_propio_otro: updatedSurveyData.tipoVehiculoPropioOtro || '',
            empresa_paga_rodamiento: updatedSurveyData.empresaPagaRodamiento || '',
            realiza_inspeccion_propio: updatedSurveyData.realizaInspeccionPropio || '',
            frecuencia_chequeo_propio: updatedSurveyData.frecuenciaChequeoPropio || '',
            usa_vehiculo_empresa: updatedSurveyData.usaVehiculoEmpresa || '',
            tipo_vehiculo_empresa: updatedSurveyData.tipoVehiculoEmpresa || '',
            tipo_vehiculo_empresa_otro: updatedSurveyData.tipoVehiculoEmpresaOtro || '',
            realiza_inspeccion_empresa: updatedSurveyData.realizaInspeccionEmpresa || '',
            frecuencia_chequeo_empresa: updatedSurveyData.frecuenciaChequeoEmpresa || '',
